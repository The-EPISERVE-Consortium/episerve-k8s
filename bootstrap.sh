...
echo "     Pin kustomize version (required for kind: Component in base/gateway):"
echo "     kubectl patch configmap argocd-cm -n argocd --patch '{\"data\":{\"kustomize.version\":\"v5.4.3\"}}'"
